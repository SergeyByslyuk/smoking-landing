...
Фоновое видео первого экрана находится в `assets/hero-hookah.mp4`, постер — в
`assets/hero-hookah-poster.jpg`. WebM можно добавить позже как более лёгкий
приоритетный формат; MP4 используется как fallback. Исходный royalty-free
ассет: Coverr, `Hookah bubbles`.
